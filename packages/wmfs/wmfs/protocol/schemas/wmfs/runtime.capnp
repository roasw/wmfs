...
struct InputAxis { input @0 :UInt16; axis @1 :UInt16; }
...
struct OutputPlan { name @0 :Text; union { dynamic @1 :Void; known @2 :KnownOutput; } }
struct VjpMetadata {
...
struct VjpPlan { union { none @0 :Void; known @1 :VjpMetadata; } }
...
interface OutputAllocator {
  allocate @0 (shape :List(UInt64), dtype :Tensor.DType) -> (tensor :Tensor.TensorDescriptor);
}
struct ScalarArgument {
  parameter @0 :UInt16;
  union { boolean @1 :Bool; float64 @2 :Float64; int64 @3 :Int64; text @4 :Text; }
}
...
struct PlannedOutput { output @0 :UInt16; shape @1 :List(UInt64); dtype @2 :Tensor.DType; }
...
struct OperationError { type @0 :Text; message @1 :Text; }
struct InvocationOutcome { union { success @0 :Void; operationError @1 :OperationError; } }
